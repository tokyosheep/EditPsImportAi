(function(){
    ...
    for(var i=0;i<objects.length;i++){
        if(objects[i].typename == "PlacedItem"){
            array.push({});
            array[array.length-1].fullName = objects[i].file.fullName;
            array[array.length-1].name = objects[i].file.name;
            array[array.length-1].path = objects[i].file.path;
        }
    }
    /*
    if(array.length < 1){
    ...
    */
    ...
    return JSON.stringify([array,name]);
})();